...
// behalf, does the crypto, and reaches a relay. The relay has no Parley
// identity, and shared HTTP mode has no single service identity; only the user
// nodes do. The host only ever sees the parley_* tools.
package main
